...
public class BigIconicTile extends FrameLayout {
	...
	private int count=-1;
	private String wc1=""; // wide content 1 to the Iconic Tile. (Like the first title, 1st line).
	private String wc2=""; // wide content 2 to the Iconic Tile. (the content, 2nd line).
	...
	private TextView tvNextCounter;
	...
	public BigIconicTile(Context context, AttributeSet attrs, int defStyle) {
	...
	public BigIconicTile(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public BigIconicTile(Context context) {
		super(context);
	...
	private void processingProperties(AttributeSet attrs) {
		...
		// wide content 1.
		setWideContent1(a.getString(R.styleable.Tile_WideContent1));
		// wide content 2.
		setWideContent2(a.getString(R.styleable.Tile_WideContent2));
		// title.
	...
	public void setWideContent1(String wc1) {
		this.wc1 = wc1;
	}

	public void setWideContent2(String wc2) {
		this.wc2 = wc2;
	}
	...
	private void inflateViews(Context context) {
		...
		ftLayout = inflater.inflate(R.layout.big_iconic_tile_template, this);

		//this.addView(ftLayout);
	}

	public void show() {
		FrontRoot = (RelativeLayout) ftLayout.findViewById(R.id.BITRoot);
		TextView tvWC1 = (TextView) ftLayout.findViewById(R.id.BITWideContent1);
		TextView tvWC2 = (TextView) ftLayout.findViewById(R.id.BITWideContent2);
		TextView tvTitle = (TextView) ftLayout.findViewById(R.id.BITTitle);
		ImageView icon = (ImageView) ftLayout.findViewById(R.id.BITIcon);
		CounterRoot = (ViewFlipper) ftLayout.findViewById(R.id.BITCounterFlipper);
		...
		// wide content 1:
		tvWC1.setText( (wc1 != null) ? wc1 : "" );
		// wide content 2:
		tvWC2.setText( (wc2 != null) ? wc2 : "" );
		// title:
		...
		if(txtColor != -16777216) {
			tvWC1.setTextColor(txtColor);
			tvWC2.setTextColor(txtColor);
